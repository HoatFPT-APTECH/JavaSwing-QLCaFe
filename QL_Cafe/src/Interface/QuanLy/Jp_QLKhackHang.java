 ...
 * @author hoatd
 */
public class Jp_QLKhackHang extends javax.swing.JPanel {
    public ConnectSQL cn = new ConnectSQL();
    /**
     * Creates new form Jp_QLKhackHang
     */
    public static  Jp_QLKhackHang kh;
    ...
    private void bntSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bntSuaActionPerformed
        ...
        if(select<0){
            ...
            DL_SuaTK_Khach sua = new DL_SuaTK_Khach(Run.QlCafe, true,Integer.parseInt(this.tbBan.getValueAt(select, 0).toString()));
            sua.setVisible(true);
        }
    ...
    private void bntXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bntXoaActionPerformed
        ...
        if (tbBan.getSelectionModel().isSelectionEmpty()) {
            JOptionPane.showMessageDialog(null, "Bạn chưa chọn khách hàng!");
        } else {
            int selectedRows = tbBan.getSelectedRow();
           KhachHang khachhang= cn.GetDetailKhachHang(Integer.parseInt(tbBan.getValueAt(selectedRows, 0).toString()));
           int  qs = JOptionPane.showConfirmDialog(null, "Xóa tài khoản: \n " + khachhang.Ten, "Xóa tài khoản", JOptionPane.YES_NO_OPTION);
