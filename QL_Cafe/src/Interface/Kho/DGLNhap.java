 ...
 * @author hoatd
 */
public class DGLNhap extends javax.swing.JDialog {

    /**
     * Creates new form DGLNhap
     */
        private TaiKhoan taikhoan = Run.tk;
    private NguyenLieu nguyenlieu;
    private ConnectSQL cn = new ConnectSQL();
    public DGLNhap(java.awt.Frame parent, boolean modal, int idNguyenLieu) {
        super(parent, modal);
        initComponents();
   ...
   public void getPropertise(int idNguyenLieu) {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Interface/Images/nhapNL.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        JOptionPane.showMessageDialog(rootPane, "Số lượng nhập không được để trống !","Cảnh báo",JOptionPane.OK_OPTION);
        else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DGLNhap.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DGLNhap dialog = new DGLNhap(new javax.swing.JFrame(), true,1);
