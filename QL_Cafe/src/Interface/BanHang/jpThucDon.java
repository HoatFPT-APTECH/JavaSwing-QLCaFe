...
public class jpThucDon extends javax.swing.JPanel {
                    ...
                    btn.addMouseListener(new MouseAdapter() {
                        ...
                        public void mousePressed(MouseEvent e) {
                            ...
                            if(arrThucDon != null){
                                ...
                                jpChonMon.setPreferredSize(new Dimension(282, 98));
                                jpChonMon.removeAll();
    ...
    private void initComponents() {
        ...
        jpLoai2 = new javax.swing.JPanel();
        ...
        jpLoai2.setBackground(Color.decode("#e6e6e6"));
        jpLoai2.setLayout(null);

        jButton7.setText("Sinh tố");
        jpLoai2.add(jButton7);
        jButton7.setBounds(0, 160, 130, 40);

        jButton8.setText("Cà phê");
        jpLoai2.add(jButton8);
        jButton8.setBounds(0, 0, 130, 40);

        jButton9.setText("Thứ khác");
        jpLoai2.add(jButton9);
        jButton9.setBounds(0, 200, 130, 40);

        jButton10.setText("Nước-Lon");
        jpLoai2.add(jButton10);
        jButton10.setBounds(0, 120, 130, 40);

        jButton11.setText("Lipton-Trà");
        jpLoai2.add(jButton11);
        jButton11.setBounds(0, 40, 130, 40);

        jButton12.setText("Nước đóng chai");
        jpLoai2.add(jButton12);
        jButton12.setBounds(0, 80, 130, 40);
        ...
        jScrollPane1.setViewportView(jpChonMon);

        javax.swing.GroupLayout jPanel1Layout = new javax.swing.GroupLayout(jPanel1);
        jPanel1.setLayout(jPanel1Layout);
        jPanel1Layout.setHorizontalGroup(
            jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(lblNhom, javax.swing.GroupLayout.DEFAULT_SIZE, 289, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(34, 34, 34)
                .addComponent(jpLoai, javax.swing.GroupLayout.DEFAULT_SIZE, 300, Short.MAX_VALUE)
                .addGap(143, 143, 143))
            .addComponent(jPanel1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
    ...
    private javax.swing.JPanel jpLoai2;
